					...
					<div class="row">
						<c:forEach items="${orders}" var="o">
							<div class="col-lg-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										<h4 class="card-title">${o.getUser().getName()}</h4>
										<p class="card-description">

											<code>${o.getUser().getEmail()}</code>
											${o.getUser().getPhone()}
										</p>
										<div class="table-responsive">
											<table class="table table-striped">
												...
												<tbody>
													<c:forEach items="${o.getItems()}" var="ot">
														<tr>
															<td>${ot.getProduct().getPid()}</td>
															<td>${ot.getProduct().getProductName()}</td>
															<td class="py-1"><img
																src="img/${ot.getProduct().getProductImage()}"
																alt="image"></td>
															<td>${o.getOrderDate()}</td>
															<td>${ot.getProduct().getProductPrice()}</td>
															<td>${ot.getProduct().getProductQty()}</td>
															<td>${ot.getProduct().getProductPrice()*ot.getProduct().getProductQty() }</td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
