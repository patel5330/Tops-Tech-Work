			...
			<div class="main-panel">
						...
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<f:form class="forms-sample" action="addcategory" method="post"
										modelAttribute="category">
										<f:hidden path="categoryId" />
										<div class="form-group">
											<f:label path="categoryName">Category Name</f:label>
											...
											<tbody>
												<c:forEach var="dt" items="${categories }">
													<tr>
														...
														<td><a href="delete?cid=${dt.getCategoryId()}"
															class="btn btn-danger">DELETE</a></td>
														<td><a href="edit?cid=${dt.getCategoryId()}"
				...
				<footer class="footer">
					<div
						...
						<span
							class="text-muted d-block text-center text-sm-left d-sm-inline-block"></span> <span
							class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">
							Copyright
							© All rights reserved  <a
							href="admin"
							target="_blank">Amadao Furniture</a> 
						</span>
					</div>
				</footer>
				<!-- partial -->
